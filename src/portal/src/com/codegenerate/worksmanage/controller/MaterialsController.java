...
import com.codegenerate.worksmanage.service.MaterialsService;
...
public class MaterialsController {
   ...
   /**
    ...
    public String list(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        // 返回JSP
        return "codegenerate/worksmanage/materials-list.jsp";
    }
    ...
    public String input(@RequestParam(value = "id", required = false) String id, Model model) {
        ...
        return "codegenerate/worksmanage/materials-input.jsp";
    }
   ...
   /**
    ...
    public void excelExport(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletResponse response) {
        ...
        // 列名
        tableModel.addHeaders("id", "materialtypeno", "materialno", "materialname", "model", "materialprice", "materialunit", "scopeid");
    ...
    public String importExport(@RequestParam("attachment") MultipartFile attachment, HttpServletResponse response) {
        try {
            ...
            tableModel.addHeaders("id", "materialtypeno", "materialno", "materialname", "model", "materialprice", "materialunit", "scopeid");
            // 导入
            new ExcelCommon().uploadExcel(file, tableModel, "com.codegenerate.worksmanage.entity.MaterialsEntity");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "redirect:/materials/materials-list.do";
