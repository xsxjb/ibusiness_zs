...
import com.codegenerate.worksmanage.service.Materials_typeService;
...
public class Materials_typeController {
   ...
   /**
    ...
    public String list(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        // 返回JSP
        return "codegenerate/worksmanage/materials_type-list.jsp";
    }
    ...
    public String input(@RequestParam(value = "id", required = false) String id, Model model) {
        ...
        return "codegenerate/worksmanage/materials_type-input.jsp";
    }
   ...
   /**
    ...
    public void excelExport(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletResponse response) {
        ...
        // 列名
        tableModel.addHeaders("id", "typeno", "typename", "parentid", "isleaf", "scopeid");
    ...
    public String importExport(@RequestParam("attachment") MultipartFile attachment, HttpServletResponse response) {
        try {
            ...
            tableModel.addHeaders("id", "typeno", "typename", "parentid", "isleaf", "scopeid");
            // 导入
            new ExcelCommon().uploadExcel(file, tableModel, "com.codegenerate.worksmanage.entity.Materials_typeEntity");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "redirect:/materials_type/materials_type-list.do";
