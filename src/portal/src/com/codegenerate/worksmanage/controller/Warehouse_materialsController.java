...
import com.codegenerate.worksmanage.service.Warehouse_materialsService;
...
public class Warehouse_materialsController {
   ...
   /**
    ...
    public String list(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        // 返回JSP
        return "codegenerate/worksmanage/warehouse_materials-list.jsp";
    }
    ...
    public String input(@RequestParam(value = "id", required = false) String id, Model model) {
        ...
        return "codegenerate/worksmanage/warehouse_materials-input.jsp";
    }
   ...
   /**
    ...
    public void excelExport(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletResponse response) {
        ...
        // 列名
        tableModel.addHeaders("id", "materialtypeno", "materialno", "materialname", "materialmodel", "materialprice", "materialunit", "materialnum", "warehouseno", "warehousename", "scopeid");
    ...
    public String importExport(@RequestParam("attachment") MultipartFile attachment, HttpServletResponse response) {
        try {
            ...
            tableModel.addHeaders("id", "materialtypeno", "materialno", "materialname", "materialmodel", "materialprice", "materialunit", "materialnum", "warehouseno", "warehousename", "scopeid");
            // 导入
            new ExcelCommon().uploadExcel(file, tableModel, "com.codegenerate.worksmanage.entity.Warehouse_materialsEntity");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "redirect:/warehouse_materials/warehouse_materials-list.do";
