...
import com.codegenerate.worksmanage.service.WarehouseService;
...
public class WarehouseController {
   ...
   /**
    ...
    public String list(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, Model model) {
        ...
        // 返回JSP
        return "codegenerate/worksmanage/warehouse-list.jsp";
    }
    ...
    public String input(@RequestParam(value = "id", required = false) String id, Model model) {
        ...
        return "codegenerate/worksmanage/warehouse-input.jsp";
    }
   ...
   /**
    ...
    public void excelExport(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletResponse response) {
        ...
        // 列名
        tableModel.addHeaders("id", "warehouseno", "warehousename", "warehouselocation", "scopeid");
    ...
    public String importExport(@RequestParam("attachment") MultipartFile attachment, HttpServletResponse response) {
        try {
            ...
            tableModel.addHeaders("id", "warehouseno", "warehousename", "warehouselocation", "scopeid");
            // 导入
            new ExcelCommon().uploadExcel(file, tableModel, "com.codegenerate.worksmanage.entity.WarehouseEntity");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "redirect:/warehouse/warehouse-list.do";
