...
CREATE TABLE IB_MATERIALS_TYPE (TYPENO VARCHAR(64), TYPENAME VARCHAR(256), PARENTID VARCHAR(64), ISLEAF VARCHAR(16), ID VARCHAR(64), SCOPEID VARCHAR(64),  PRIMARY KEY (ID)) ENGINE=INNODB;

/*==============================================================*/
/* 物料表   */
/*==============================================================*/
DROP TABLE IF EXISTS IB_MATERIALS;
CREATE TABLE IB_MATERIALS (MATERIALNO VARCHAR(64), MATERIALNAME VARCHAR(64), MATERIALPRICE DOUBLE(12,2), MATERIALTYPENO VARCHAR(64), MATERIALUNIT VARCHAR(8), MODEL VARCHAR(64), ID VARCHAR(64), SCOPEID VARCHAR(64),  PRIMARY KEY (ID)) ENGINE=INNODB;
