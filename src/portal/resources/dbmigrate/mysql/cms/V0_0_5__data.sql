...
INSERT INTO IB_MENU(ID,MENUNAME,MENULEVEL,MENUURL,MENUIFRAME, MENUORDER,PARENTID) VALUES('ib_indeximgbyworks0002','首页图片配置','3','/indeximgbyworks/indeximgbyworks-list.do','URL','2','mTwoindex26');
/*===============   菜单和角色模板关联表  =============================*/
