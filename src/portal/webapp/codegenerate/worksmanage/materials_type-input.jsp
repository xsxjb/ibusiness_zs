...
<html>
  ...
  <body>
    ...
    <div class="panel panel-default col-lg-12"> 
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">原料分类管理编辑</h4></div>
                ...
                <form id="cgForm" method="post" action="materials_type-save.do" class="form-horizontal">
                  ...
                  <div class="form-group">
	                  <div class="col-lg-10 col-lg-offset-2">
	                      ...
	                      <button type="button" onclick="location.href='materials_type-list.do'" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-log-out"></span> 关闭</button>
	                  </div>
                  </div>
                </form>
        </div>
